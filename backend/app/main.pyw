...
from .core.resource_balance import build_resource_balance
...
resource_balance = build_resource_balance()
...
public_context_recall = LocalContextRecall(PUBLIC_CONTEXT)
...
service = AICoreService(
    ...
    public_context_recall=public_context_recall, agent_runner=orchestrator,
    allow_private_model_context=PRIVATE_MODEL_ENABLED, resource_balance=resource_balance
)
